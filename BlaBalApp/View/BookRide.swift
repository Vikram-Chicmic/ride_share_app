...
struct BookRide: View {
    ...
    var body: some View {
        VStack(alignment: .leading) {
            ...
            Text("Select number of seats :").fontWeight(.semibold).font(.title3).padding(.vertical).padding(.top, 50)
            HStack {
