...
//    static var colorScheme: ColorScheme = .dark // Assuming colorScheme is defined in Constants
    ...
    struct Url {
        ...
        static let phoneVerify              = baseUrl+"phone"
        static let sendOTP                  = baseUrl+"verify"
        ...
        static let forgotPassword           = baseUrl+"send_otp"
        static let verifyEmailOtp           = baseUrl+"verify_otp"
        static var resetPassword            = baseUrl+"password_reset"
